...
def ReplaceApnList(info):
  ...
  info.script.AppendExtra('endif;')
  info.script.AppendExtra('endif;')
  info.script.AppendExtra('ifelse(getprop("ro.boot.carrier") == "retus" && getprop("ro.boot.fsg-id") == "vzw", run_program("/sbin/sh", "-c", "mv /system/etc/cdma/apns-conf-vzw.xml /system/etc/apns-conf.xml"));')
